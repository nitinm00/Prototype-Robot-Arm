...
const NeZCData *ArmReverseKinematics_aa99d991_1_ZCData = NULL;
PmfMessageId ArmReverseKinematics_aa99d991_1_computeAsmModeVector(const double
...
PmfMessageId ArmReverseKinematics_aa99d991_1_computeSimModeVector(const double
  *input, const double *inputDot, const double *inputDdot, int *modeVector,
  double *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId ArmReverseKinematics_aa99d991_1_computeZeroCrossings(const
