...
void ArmReverseKinematics_aa99d991_1_perturbSimJointPrimitiveState(const void
...
void ArmReverseKinematics_aa99d991_1_perturbFlexibleBodyState(const void *mech,
...
void ArmReverseKinematics_aa99d991_1_constructStateVector(const void *mech,
...
void ArmReverseKinematics_aa99d991_1_extractSolverStateVector(const void *mech,
...
boolean_T ArmReverseKinematics_aa99d991_1_isPositionViolation(const void *mech,
...
boolean_T ArmReverseKinematics_aa99d991_1_isVelocityViolation(const void *mech,
  const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const
  double *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId ArmReverseKinematics_aa99d991_1_projectStateSim(const void *mech,
...
void ArmReverseKinematics_aa99d991_1_computeConstraintError(const void *mech,
...
boolean_T ArmReverseKinematics_aa99d991_1_hasJointDisToNormModeChange(const void
...
void ArmReverseKinematics_aa99d991_1_onModeChangedCutJoints(const void *mech,
