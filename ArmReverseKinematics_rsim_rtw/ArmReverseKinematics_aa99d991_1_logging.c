...
PmfMessageId ArmReverseKinematics_aa99d991_1_recordLog(const
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  logVector[8] = xx[0] * inputDdot[0];
  logVector[9] = xx[0] * inputDdot[1];
  logVector[10] = xx[0] * inputDdot[2];
  logVector[11] = xx[0] * inputDdot[3];
  errorResult[0] = 0.0;
  return NULL;
}
