...
#include "nesl_rtw.h"
#include "ArmReverseKinematics_aa99d991_1.h"
#include "ArmReverseKinematics_aa99d991_1_gateway.h"

void ArmReverseKinematics_aa99d991_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0.001, 0.001, 1, 0,
    (NeModifyAbsTol) 2, 0.001, 0, 0, 0, 0, (SscLoggingSetting) 0, 637666902, 0,
    0, 0, };
  ...
  ArmReverseKinematics_aa99d991_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "ArmReverseKinematics/Arm/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
