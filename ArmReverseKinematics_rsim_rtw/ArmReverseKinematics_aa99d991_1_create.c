...
extern const NeAssertData ArmReverseKinematics_aa99d991_1_assertData[];
extern const NeZCData ArmReverseKinematics_aa99d991_1_ZCData[];
void ArmReverseKinematics_aa99d991_1_computeRuntimeParameters(
  const double *runtimeRootVariables,
  double *runtimeParameters);
void ArmReverseKinematics_aa99d991_1_validateRuntimeParameters(
  const double *runtimeParameters,
  int32_T *assertSatisfactionFlags);
void ArmReverseKinematics_aa99d991_1_computeAsmRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void ArmReverseKinematics_aa99d991_1_computeSimRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void ArmReverseKinematics_aa99d991_1_initializeGeometries(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
PmfMessageId ArmReverseKinematics_aa99d991_1_compDerivs(
...
PmfMessageId ArmReverseKinematics_aa99d991_1_numJacPerturbLoBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId ArmReverseKinematics_aa99d991_1_numJacPerturbHiBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId ArmReverseKinematics_aa99d991_1_checkDynamics(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId ArmReverseKinematics_aa99d991_1_compOutputsDyn(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId ArmReverseKinematics_aa99d991_1_compOutputsKin(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId ArmReverseKinematics_aa99d991_1_compOutputs (
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId ArmReverseKinematics_aa99d991_1_computeAsmModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId ArmReverseKinematics_aa99d991_1_computeSimModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId ArmReverseKinematics_aa99d991_1_computeZeroCrossings(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId ArmReverseKinematics_aa99d991_1_recordLog(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
void ArmReverseKinematics_aa99d991_1_setTargets(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  CTarget *targets);
void ArmReverseKinematics_aa99d991_1_resetAsmStateVector(const void *mech,
  double *stateVector);
void ArmReverseKinematics_aa99d991_1_resetSimStateVector(const void *mech,
  double *stateVector);
void ArmReverseKinematics_aa99d991_1_initializeTrackedAngleState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *modeVector,
  const double *motionData,
  double *stateVector);
void ArmReverseKinematics_aa99d991_1_computeDiscreteState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  double *stateVector);
void ArmReverseKinematics_aa99d991_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void ArmReverseKinematics_aa99d991_1_perturbAsmJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void ArmReverseKinematics_aa99d991_1_perturbSimJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void ArmReverseKinematics_aa99d991_1_perturbFlexibleBodyState(
  const void *mech,
  size_t stageIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void ArmReverseKinematics_aa99d991_1_computePosDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *matrix);
void ArmReverseKinematics_aa99d991_1_computeVelDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  const double *stateVector,
  int partialType,
  double *matrix);
void ArmReverseKinematics_aa99d991_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void ArmReverseKinematics_aa99d991_1_propagateMotion(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  double *motionData);
size_t ArmReverseKinematics_aa99d991_1_computeAssemblyError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  const double *motionData,
  double *error);
size_t ArmReverseKinematics_aa99d991_1_computeAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t ArmReverseKinematics_aa99d991_1_computeFullAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  const double *motionData,
  double *J);
boolean_T ArmReverseKinematics_aa99d991_1_isInKinematicSingularity(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  const int *modeVector,
  const double *motionData);
void ArmReverseKinematics_aa99d991_1_convertStateVector(
  const void *asmMech,
...
void ArmReverseKinematics_aa99d991_1_constructStateVector(
  const void *mech,
...
void ArmReverseKinematics_aa99d991_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
boolean_T ArmReverseKinematics_aa99d991_1_isPositionViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
boolean_T ArmReverseKinematics_aa99d991_1_isVelocityViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
PmfMessageId ArmReverseKinematics_aa99d991_1_projectStateSim(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *modeVector,
  double *stateVector,
  void *neDiagMgr);
void ArmReverseKinematics_aa99d991_1_computeConstraintError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  double *error);
void ArmReverseKinematics_aa99d991_1_resetModeVector(const void *mech, int
  *modeVector);
boolean_T ArmReverseKinematics_aa99d991_1_hasJointDisToNormModeChange(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector);
PmfMessageId ArmReverseKinematics_aa99d991_1_performJointDisToNormModeChange(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *prevModeVector,
  ...
  double *stateVector,
  void *neDiagMgr);
void ArmReverseKinematics_aa99d991_1_onModeChangedCutJoints(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector,
  double *stateVector);
PmfMessageId ArmReverseKinematics_aa99d991_1_assemble(const double *u, double
  *udot, double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  ...
  const NeParameterBundle *paramBundle)
{
  ...
  if (smData->mRuntimeParameterScalars.mN == 0)
    return;
  ArmReverseKinematics_aa99d991_1_computeRuntimeParameters(
    runtimeRootVariables,
    smData->mRuntimeParameterScalars.mX);
  ArmReverseKinematics_aa99d991_1_computeAsmRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mAsmRuntimeDerivedValuesBundle);
  ArmReverseKinematics_aa99d991_1_computeSimRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mSimRuntimeDerivedValuesBundle);
  ArmReverseKinematics_aa99d991_1_initializeGeometries
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  (void) systemInput;
  (void) neDiagMgr;
  ArmReverseKinematics_aa99d991_1_validateRuntimeParameters(
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = ArmReverseKinematics_aa99d991_1_compDerivs(
      &smData->mSimRuntimeDerivedValuesBundle,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = ArmReverseKinematics_aa99d991_1_numJacPerturbLoBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = ArmReverseKinematics_aa99d991_1_numJacPerturbHiBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  errorId = ArmReverseKinematics_aa99d991_1_compOutputs(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mM.mX,
    systemInput->mU.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = ArmReverseKinematics_aa99d991_1_computeSimModeVector(
    systemInput->mU.mX,
    systemInput->mU.mX + 4,
    systemInput->mV.mX + 4,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  double errorResult = 0.0;
  return
    ArmReverseKinematics_aa99d991_1_computeZeroCrossings(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 4,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  ArmReverseKinematics_aa99d991_1_constructStateVector(
    NULL,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 4,
    systemInput->mD.mX,
    fullStateVector);
  errorId = ArmReverseKinematics_aa99d991_1_recordLog(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    fullStateVector,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL) {
    double result = 0.0;
    errorId = ArmReverseKinematics_aa99d991_1_checkDynamics(
      &smData->mSimRuntimeDerivedValuesBundle,
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 4,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mAssemblyModeVector.mN > 0) {
    errorId = ArmReverseKinematics_aa99d991_1_computeAsmModeVector(
      systemInput->mU.mX,
      systemInput->mU.mX + 4,
      systemInput->mV.mX + 4,
  ...
  ArmReverseKinematics_aa99d991_1_checkTargets(
    &smData->mSimRuntimeDerivedValuesBundle,
  ...
  void initStateVector(NeDaePrivateData *smData)
{
  ...
  const CTarget targets[16] = {
    { 0, 21, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 21, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 28, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 28, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 29, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 29, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 30, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 30, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 21, 0, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 21, 0, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 28, 0, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 28, 0, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 29, 0, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 29, 0, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 30, 0, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 30, 0, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } }
  };
  ...
  smData->mNumInputMotionPrimitives = 4;
...
static void initAsserts(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumParamAsserts > 0) {
    const NeAssertData *ad = ArmReverseKinematics_aa99d991_1_assertData;
    size_t i;
...
static void initZeroCrossings(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumZeroCrossings > 0) {
    const NeZCData *zcd = ArmReverseKinematics_aa99d991_1_ZCData;
    size_t i;
  ...
  void initDirectFeedthrough(NeDaePrivateData *smData)
{
  ...
  const boolean_T directFeedthroughMatrix[32] = {
  ...
  {
    const int_T status = pm_create_bool_vector_fields(
      &smData->mDirectFeedthroughMatrix, 32, alloc);
    checkMemAllocStatus(status);
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mSetTargets = ArmReverseKinematics_aa99d991_1_setTargets;
  delegate->mResetStateVector =
    ArmReverseKinematics_aa99d991_1_resetAsmStateVector;
  delegate->mInitializeTrackedAngleState =
    ArmReverseKinematics_aa99d991_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState =
    ArmReverseKinematics_aa99d991_1_computeDiscreteState;
  delegate->mAdjustPosition = ArmReverseKinematics_aa99d991_1_adjustPosition;
  delegate->mPerturbJointPrimitiveState =
    ArmReverseKinematics_aa99d991_1_perturbAsmJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState = NULL;
  delegate->mComputePosDofBlendMatrix =
    ArmReverseKinematics_aa99d991_1_computePosDofBlendMatrix;
  delegate->mComputeVelDofBlendMatrix =
    ArmReverseKinematics_aa99d991_1_computeVelDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    ArmReverseKinematics_aa99d991_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion = ArmReverseKinematics_aa99d991_1_propagateMotion;
  delegate->mComputeAssemblyError =
    ArmReverseKinematics_aa99d991_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    ArmReverseKinematics_aa99d991_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    ArmReverseKinematics_aa99d991_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    ArmReverseKinematics_aa99d991_1_isInKinematicSingularity;
  delegate->mConvertStateVector =
    ArmReverseKinematics_aa99d991_1_convertStateVector;
  ...
  void initSimulationDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector =
    ArmReverseKinematics_aa99d991_1_resetSimStateVector;
  delegate->mInitializeTrackedAngleState = NULL;
  delegate->mComputeDiscreteState = NULL;
  delegate->mAdjustPosition = NULL;
  delegate->mPerturbJointPrimitiveState =
    ArmReverseKinematics_aa99d991_1_perturbSimJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState =
    ArmReverseKinematics_aa99d991_1_perturbFlexibleBodyState;
  ...
  delegate->mExtractSolverStateVector =
    ArmReverseKinematics_aa99d991_1_extractSolverStateVector;
  delegate->mIsPositionViolation =
    ArmReverseKinematics_aa99d991_1_isPositionViolation;
  delegate->mIsVelocityViolation =
    ArmReverseKinematics_aa99d991_1_isVelocityViolation;
  delegate->mProjectStateSim = ArmReverseKinematics_aa99d991_1_projectStateSim;
  delegate->mComputeConstraintError =
    ArmReverseKinematics_aa99d991_1_computeConstraintError;
  delegate->mResetModeVector = ArmReverseKinematics_aa99d991_1_resetModeVector;
  delegate->mHasJointDisToNormModeChange =
    ArmReverseKinematics_aa99d991_1_hasJointDisToNormModeChange;
  delegate->mPerformJointDisToNormModeChange =
    ArmReverseKinematics_aa99d991_1_performJointDisToNormModeChange;
  delegate->mOnModeChangedCutJoints =
    ArmReverseKinematics_aa99d991_1_onModeChangedCutJoints;
  delegate->mMech = NULL;
}
...
{
  PmAllocator *alloc = pm_default_allocator();
  const int32_T motionInputOffsets[4] = {
    0, 1, 2, 3
  };
